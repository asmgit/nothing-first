...
5. Metrics are counted over the shipped part of the answer only, per the counting rules in judges.md, and aggregated into [../README.md](../README.md). Dated run writeups live in [../results/](../results/), append-only: a superseded run is kept with a one-line reason, never silently replaced.
